...
public final class ShowViewerQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Viewer: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String? = nil, email: String, avatarUrl: String) {
        self.init(unsafeResultMap: ["__typename": "User", "id": id, "name": name, "email": email, "avatarUrl": avatarUrl])
      }
